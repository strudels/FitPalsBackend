...
project = u'Fitpals Web API'
copyright = u'2015, strudels'
...
htmlhelp_basename = 'FitpalsWebAPIdoc'
...
latex_documents = [
  ('index', 'FitpalsWebAPI.tex', u'Fitpals Web API Documentation',
   u'strudels', 'manual'),
]
...
man_pages = [
    ('index', 'fitpalswebapi', u'Fitpals Web API Documentation',
     [u'strudels'], 1)
]
...
texinfo_documents = [
  ('index', 'FitpalsWebAPI', u'Fitpals Web API Documentation',
   u'strudels', 'FitpalsWebAPI', 'One line description of project.',
   'Miscellaneous'),
]
